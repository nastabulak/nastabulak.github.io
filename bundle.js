...
var ArticleSection = function () {
    ...
    _createClass(ArticleSection, [{
        key: "createArticlesSection",
        value: function createArticlesSection() {
            var div = document.createElement("div");

            div.innerHTML = this.data.map(function (articleData) {
                var article = new _article2.default(articleData);
        ...
        key: "addArticlesSectionToView",
        value: function addArticlesSectionToView() {
...
},{"./article.js":328}],328:[function(require,module,exports){
"use strict";
...
var Article = function () {
    function Article(_ref) {
        var author = _ref.author,
            ...
            description = _ref$description === undefined ? "No details" : _ref$description,
                ...
                return regeneratorRuntime.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 5:
                                json = _context.sent;
                                return _context.abrupt("return", json.articles);
...
var _checkBox = require("./check-box.js");
...
var CheckBoxSection = function () {
    function CheckBoxSection(sources) {
        _classCallCheck(this, CheckBoxSection);

        this.sources = sources;
    }

    _createClass(CheckBoxSection, [{
        key: "createSourcesList",
        value: function createSourcesList() {

            return this.sources.map(function (source) {
                var checkBox = new _checkBox2.default(source);
                return checkBox.createCheckBox();
            }).join("");
        }
    }, {
        key: "createSourcesSection",
        value: function createSourcesSection() {
            return "<form>" + this.createSourcesList() + " </form> " + this.createGetNewsButton();
        }
    }, {
        key: "addSourcesSectionToView",
        value: function addSourcesSectionToView() {
...
},{"./check-box.js":331}],331:[function(require,module,exports){
"use strict";
...
var logger = exports.logger = new Logger("production");
...
var Notification = function () {
    function Notification(enviroment) {
    ...
    _createClass(Notification, [{
        ...
        key: "createErrorNotificationTemplate",
        value: function createErrorNotificationTemplate() {
            var message = "\u0427\u0442\u043E-\u0442\u043E \u043F\u043E\u0448\u043B\u043E \u043D\u0435 \u0442\u0430\u043A. \u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u0437\u0430\u0433\u0440\u0443\u0437\u0438\u0442\u044C \u043D\u043E\u0432\u043E\u0441\u0442\u0438";
            alert(message);
        }
    }]);
...
var notification = exports.notification = new Notification("production");
...
var _channelData = require("./channel-data.js");

var _channelData2 = _interopRequireDefault(_channelData);

var _articleSection = require("./article-section.js");

var _articleSection2 = _interopRequireDefault(_articleSection);

var _checkBoxSection = require("./check-box-section.js");

var _checkBoxSection2 = _interopRequireDefault(_checkBoxSection);
...
var PageController = function () {
    ...
    _createClass(PageController, [{
        ...
        value: function getNews() {
            ...
            return this.getCheckedChannels().forEach(function (channel) {
                _this.getChannelNews(channel);
            });
        }
    }, {
        key: "getChannelNews",
        value: function () {
            var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(channel) {
                ...
                return regeneratorRuntime.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                _context.prev = 0;
                                channelData = new _channelData2.default(channel);
                                _context.next = 4;
                            ...
                            case 4:
                                ...
                                _logger.logger.info("loaded: " + channel);
                                _context.next = 13;
                                break;
                            ...
                            case 9:
                                ...
                                _logger.logger.error("error during loading news from " + channel);
            ...
            function getChannelNews(_x) {
                return _ref.apply(this, arguments);
            }

            return getChannelNews;
        }()
    }, {
        key: "renderArticleSection",
        value: function renderArticleSection(articles) {
            var section = new _articleSection2.default(articles);
            section.addArticlesSectionToView();
        }
    }, {
        key: "renderCheckBoxSection",
        value: function renderCheckBoxSection() {
            var section = new _checkBoxSection2.default(this.sources);
            section.addSourcesSectionToView();
        }
    }, {
        key: "getCheckedChannels",
        value: function getCheckedChannels() {
            var checkedChannels = Array.from(document.forms[0].elements).filter(function (resource) {
                return resource.checked;
            }).map(function (channel) {
                return channel.value;
            });
            _logger.logger.info("checked channels: " + checkedChannels);
...
},{"./article-section.js":327,"./channel-data.js":329,"./check-box-section.js":330,"./logger.js":332,"./notification.js":333,"babel-polyfill":1,"whatwg-fetch":326}],335:[function(require,module,exports){
"use strict";

var _pageController = require("./page-controller.js");

var _pageController2 = _interopRequireDefault(_pageController);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var page = new _pageController2.default();
page.renderCheckBoxSection();

var button = document.getElementById("getNews");
button.addEventListener("click", function () {
  return document.getElementById("articles").innerHTML = "";
});
button.addEventListener("click", page.getNews.bind(page));

},{"./page-controller.js":334}]},{},[335]);
